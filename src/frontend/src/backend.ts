...
export class Backend implements backendInterface {
    ...
    async getReturnPolicy(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getReturnPolicy();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isInitializedQuery(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isInitializedQuery();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrder(arg0: string, arg1: string, arg2: string, arg3: Array<OrderItem>, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
